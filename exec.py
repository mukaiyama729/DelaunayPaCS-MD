...
if __name__ == '__main__':
    ...
    parser.add_argument('--nbins', type=str, help='pacsmdの手法', default=50)
    parser.add_argument('--nround', type=int, help='スレッド数', default=100)
    parser.add_argument('--parallel', type=str, help='distPaCSMDなら指定', default=2)
    parser.add_argument('--how_many', type=str, help='distPaCSMDなら指定', default=1)
